                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            @foreach ($employees as $employee)
                                <tr>
                                    ...
                                    <td>{{ $employee->employee_role_2 }}</td>
                                    <td>
                                        <a href="/employee/{{ $employee->employee_id }}/edit" class="btn btn-info btn-sm">
                                            <span>Edit</span>
                                        </a> 
                                        <form action="/employee/{{ $employee->employee_id }}" method="post" class="d-inline">
                                            @csrf
                                            @method('delete')
